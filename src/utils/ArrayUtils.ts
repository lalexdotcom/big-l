...
export namespace ArrayUtils {
	...
	export function sortFunction<T = any>(fieldOrAccessor: keyof T | string | ((o: any) => any), desc?: boolean) {
		const accessor =
	...
	export function sortBy<T>(arr: T[], fieldOrAccessor: keyof T | string | ((o: T) => any), desc?: boolean): T[] {
